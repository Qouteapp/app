...
export default {
  ...
  lng_update_ulu: 'ulu is ready to update ✨',
  ...
  OnboardingInboxTitle: 'Create Inbox',
  OnboardingInboxSubtitle: 'Inbox is a shared folder with all incoming chats, much like mail.',
  OnboardingInboxOptionUluDescription: 'Inbox will be created only in Ulu. In other clients this folder will not be created',
  OnboardingInboxOptionUluTitle: 'Ulu only',
  OnboardingInboxOptionUluSubtitle: 'Default',
  OnboardingInboxOptionEverywhereDescription: 'Inbox folder will be created across all of your Telegram clients',
  OnboardingInboxOptionEverywhereTitle: 'Everywhere',
  OnboardingFoldersStyleTitle: 'Folders style',
  OnboardingFoldersStyleSubtitle: 'Select the type of folder display that best suits your needs',
  OnboardingFoldersStyleOptionSlackDescription: 'Folders are arranged vertically, one on top of the other. Multiple folders can be opened at once',
  OnboardingFoldersStyleOptionSlackTitle: 'Slack like',
  OnboardingFoldersStyleOptionTelegramDescription: 'Folders are arranged horizontally. Only one folder is opened at once',
  OnboardingFoldersStyleOptionTelegramTitle: 'Telegram',
  ...
  OnboardingActionLater: 'Later',
  OnboardingActionFinish: 'Finish',
} as ApiLangPack;
