...
export default {
  ...
  OnboardingInboxOptionTelegramDescription: 'Inbox folder will be created across all of your Telegram clients',
  OnboardingInboxOptionTelegramTitle: 'Everywhere',
